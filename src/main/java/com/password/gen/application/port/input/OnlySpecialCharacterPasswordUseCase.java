...
public interface OnlySpecialCharacterPasswordUseCase {
    PasswordGeneratorDomain generateOnlySpecialCharacterPassword(String length) throws PasswordGeneratorException;
}
